...
public class MainActivity extends AppCompatActivity {
    ...
    private void showInfoDialog() {
        ...
        GemSystemInfo info = gem.getSystemInfo();

        if(info != null) {
            ((TextView)aboutView.findViewById(R.id.text_gem_address)).setText(info.address);
            ((TextView)aboutView.findViewById(R.id.text_gem_name)).setText(info.name);
            ((TextView)aboutView.findViewById(R.id.text_fw_revision))
                    .setText(info.firmwareRevision);
            ((TextView)aboutView.findViewById(R.id.text_hw_revision))
                    .setText(info.hardwareRevision);
        }
